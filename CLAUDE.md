...
llama32-3b-serving-trt-engine — serves a pre-compiled TRT-LLM engine via `trtllm-serve` on the Miramar platform.
...
| Engine              | `engine_gb10/` — GB10 Blackwell, bfloat16, TP=1, max_batch_size=8, max_seq_len=4096 |
